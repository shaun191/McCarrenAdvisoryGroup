  ...
  rel="noopener noreferrer" className="inline-flex items-center rounded-2xl bg-white px-6 py-4 text-base font-semibold text-slate-950 shadow-sm hover:bg-slate-100">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-600">
              Our work is designed for privately held, founder-led, family-owned, and lower-middle-market companies where leadership transition is not just an HR issue â it is an operational risk.
            </p>
          </div>
      ...
      <section id="contact" className="bg-white py-20 text-slate-950">
        <div className="mx-auto max-w-4xl px-6 text-center lg:px-8">
          ...
          <p className="mt-6 text-lg leading-8 text-slate-600">
            Start with a confidential readiness conversation. We will discuss where the business is most dependent on the current owner and what would need to change before succession, sale, or transition. Prefer to talk now? Call <a href="tel:+17792108351" className="font-semibold text-slate-900 underline">(779) 210-8351</a>.
          </p>
          <div className="mt-10">
